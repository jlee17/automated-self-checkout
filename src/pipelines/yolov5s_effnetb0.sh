...
DETECTION_OPTIONS="${DETECTION_OPTIONS:="gpu-throughput-streams=4 nireq=4 batch-size=$BATCH_SIZE"}" # Extra detection model parameters ex. "" | gpu-throughput-streams=4 nireq=4 batch-size=1
